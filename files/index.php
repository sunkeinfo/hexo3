...
class config {
  ...
  public static $default = array(
    ...
    // login
    'username' => 'sunke',
    'password' => '123321', // Add password directly or use https://tinyfilemanager.github.io/docs/pwd.html to encrypt the password (encrypted password is more secure, as it prevents your password from being exposed directly in a file).
    ...
    // files layout
    'layout' => 'list', // list, blocks, grid, rows, columns
